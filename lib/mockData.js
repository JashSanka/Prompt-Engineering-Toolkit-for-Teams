    ...
    outputs: [
      {
        test_case_id: "tc1",
        input: "The global electric vehicle market grew 35% in 2025...",
        output: "• EV market grew 35% in 2025\n• China is leading\n• Europe grew 42%",
        exec_time_ms: 1050,
        token_count: 32,
        score: 2,
        keyword_match: 65,
      ...
      },
      {
        test_case_id: "tc2",
        input: "Researchers at MIT have developed...",
        output: "• MIT developed a 98% accurate AI model\n• It predicts protein structures\n• It reduces drug development timelines",
        exec_time_ms: 850,
        token_count: 40,
        score: 2,
        keyword_match: 70,
    ...
    outputs: [
      {
        test_case_id: "tc1",
        input: "The global electric vehicle market grew 35% in 2025...",
        output: "The EV market grew by 35% with China leading and Europe also growing.",
        exec_time_ms: 1300,
        token_count: 20,
        score: 1,
        keyword_match: 40,
      ...
      },
      {
        test_case_id: "tc2",
        input: "Researchers at MIT have developed...",
        output: "MIT made an AI that predicts protein structures fast.",
        exec_time_ms: 1100,
        token_count: 15,
        score: 1,
        keyword_match: 35,
